...
typedef struct {
    bool compileOnly, toAssemblyOnly, preprocessOnly;
 ...
 *     -O1: optimize
 *     -O0: do not optimize
 *     -Ipath: add path to include paths
 *     -ofile: compile to file
 *     -xmode: sets the language mode for indeterminable files
 *     -: add file from stdin
